<!--
  Fork-maintained: upstream inlined the list sidebar into each page and deleted
  this shared component (resource-list cleanup). The semantic studio and the
  automations list still use it; migrate or drop it with those pages.
-->
<template>
